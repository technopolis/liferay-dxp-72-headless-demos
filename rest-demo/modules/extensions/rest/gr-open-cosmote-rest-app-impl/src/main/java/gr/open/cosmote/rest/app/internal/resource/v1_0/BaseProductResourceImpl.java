...
public abstract class BaseProductResourceImpl implements ProductResource {
	 ...
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/cosmote-rest-app/v1.0/campaigns/product/{idRef}'  -u 'test@liferay.com:test'
	 */
	@Override
	@GET
	@Parameters(value = {@Parameter(in = ParameterIn.PATH, name = "idRef")})
	@Path("/campaigns/product/{idRef}")
	@Produces({"application/json", "application/xml"})
	@Tags(value = {@Tag(name = "Product")})
	public Product getCampaignProduct(
			@NotNull @Parameter(hidden = true) @PathParam("idRef") String idRef)
		throws Exception {
