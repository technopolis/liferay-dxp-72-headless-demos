...
public interface ProductResource {
	...
	public Product getCampaignProduct(String idRef) throws Exception;

	public HttpInvoker.HttpResponse getCampaignProductHttpResponse(String idRef)
		throws Exception;
	...
	public static class ProductResourceImpl implements ProductResource {
		...
		public Product getCampaignProduct(String idRef) throws Exception {
			HttpInvoker.HttpResponse httpResponse =
				getCampaignProductHttpResponse(idRef);
			...
			try {
				return gr.open.cosmote.rest.app.client.serdes.v1_0.
					ProductSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse getCampaignProductHttpResponse(
				String idRef)
			throws Exception {
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/cosmote-rest-app/v1.0/campaigns/product/{idRef}",
				idRef);
